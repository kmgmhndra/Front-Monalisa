                ...
                <div class="hidden sm:block justify-end">
                    ...
                    <div class="relative min-w-72 md:min-w-80">
                        ...
                        <input type="text" id="icon" name="icon"
                            class="py-2 px-4 ps-11 block w-full border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            placeholder="Search">
                    </div>
                </div>
                                            ...
                                            <div class="px-6 py-3 mr-10">
                                                <span
                                                    ...
                                                    <svg class="size-3" xmlns="http://www.w3.org/2000/svg" width="16"
                                                        ...
                                                        style="fill: rgba(19, 78, 74, 1);transform: ;msFilter:;">
                                                        <path
