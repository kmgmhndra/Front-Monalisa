 ...
 ">
    ...
    <div class="w-full  lg:ps-64">
        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="adm3"
                                class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white"
                                onclick="window.location='administrasi';">521211-Belanja
                                Bahan (17 SPJ)</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="transaksi"
                                class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">SPM
                                157 Kwt 1051</a>
                        </div>
                    </li>
            ...
            <!-- File Input -->
            <!-- Formulir Upload File dengan Tailwind CSS -->
            <form class="flex items-center justify-between p-4 bg-white border rounded-lg border-gray-300">
                <!-- Input File Multiple -->
                <input
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-3 py-3 text-start">
                                                <div class="flex items-center gap-x-3">
                                                    <button data-hs-overlay="#hs-large-modal">
                                                        <span
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-3 py-1.5">
                                                ...
                                                <button
                                                    class="bg-green-600 hover:bg-green-700 text-white p-1 rounded focus:outline-none focus:shadow-outline">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        viewBox="0 0 24 24"
                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 py-3 ml-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                    viewBox="0 0 24 24"
                                                    style="fill: rgba(112, 108, 108, 1);transform: ;msFilter:;">
                                                    <path
                                                        d="M8.267 14.68c-.184 0-.308.018-.372.036v1.178c.076.018.171.023.302.023.479 0 .774-.242.774-.651 0-.366-.254-.586-.704-.586zm3.487.012c-.2 0-.33.018-.407.036v2.61c.077.018.201.018.313.018.817.006 1.349-.444 1.349-1.396.006-.83-.479-1.268-1.255-1.268z">
                                                    </path>
                                                    <path
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-3 py-3 text-start">
                                                <div class="flex items-center gap-x-3">
                                                    <span
                                                        class="text-sm font-medium text-gray-400 dark:text-neutral-200 ml-3 mr-32">
                                                        SPBY.pdf
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3 mr-10">
                                                <span
                                                    class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-red-300 text-teal-800 rounded-full dark:bg-teal-500/10 dark:text-teal-500">
                                                    <svg class="size-2.5" xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="none" viewBox="0 0 16 16">
                                                        <path stroke="currentColor" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-width="2"
                                                            d="M3 3l10 10M13 3L3 13"></path>
                                                    </svg>
                                                    Belum
                                                </span>
                                            </div>
